...
Aqui algunas de las alternativas consideradas para la elección de los $k$ menores, con $n$: cantidad de imágenes:
\begin{enumerate}
...
Si fijamos por ejemplo $k = 25$ y $n = 42000$ (n maximo), podemos realizar la siguiente comparación:

\begin{center}
    \begin{tabular}{| c | c |}
    \hline
    Complejidad   &  Cantidad de operaciones estimada \\ \hline
...
\todo[inline]{TODO: Estaria bueno en la experimentacion hacer una medicion de tiempos.}
