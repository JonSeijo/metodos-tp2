...
int main() {
    ...
    // header:
    cout << "k,clase,precision,recall,f1,tiempo\n";

    // a futuro hacer k_knn desde 20 hasta 30 quiza
    for (int k_knn = 30; k_knn < 35; k_knn++) {
        ...
        for (int j = 0; j < 10; j++) {
            cout << k_knn << "," << j << "," << precision_posta[j] << ",";
                cout << recall_posta[j] << "," << f1_posta[j] << "," << tiempo_posta << "\n";
        }
